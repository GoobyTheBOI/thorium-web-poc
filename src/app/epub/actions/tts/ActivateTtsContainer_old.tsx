...
import { TtsOrchestrationService, ITtsOrchestrationService } from "@/lib/services/TtsOrchestrationService";
import { VoiceManagementService, IVoiceManagementService } from "@/lib/services/VoiceManagementService";
...
export const ActivateTtsContainer: React.FC<StatefulActionContainerProps> = (props) => {
    ...
    const getCurrentEpubTextWithElements = async (): Promise<TextChunk[]> => {
        try {
    ...
    const handleStartTts = async () => {
        try {
            ...
            for (let i = 0; i < chunksToSend.length; i++) {
                ...
                const result = await adapter.playWithContext(
                    textChunk,
